<template>
  <div class="category">
    ...
    <div class="categorycontent">
      <scroll class="scroll1" :probe-type="3" :click="true" :pull-up-load="true">
      ...
      <scroll  :probe-type="3" :click="true" :pull-up-load="true" ref="scroll" class="scroll2" v-if="showTop.length !=0 && Object.keys(showBottom).length != 0">
        <top :top="categorydata[currentIndex] ? showTop: []" class="abc"/>
        <tab-control :title="['流行','新款','精选']" @tabClick="tabClick"/>
        <goods-list :goods-list="categorydata[currentIndex] ? showBottom: []"/>
      </scroll>
